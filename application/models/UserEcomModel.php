...
Class UserEcomModel extends CI_Model
{
    ...
    public function check_data($table, $where, $order, $order_type){
        $this->db->select('*');
        $this->db->from($table);
        $this->db->where($where);
    ...
    public function join_two_table($table, $table1, $table2, $where, $JOIN, $JOIN1, $select, $order){
        $this->db->select($select);
        $this->db->from($table);
    ...
    public function join_two_table_type($table, $table1, $table2, $where, $JOIN, $JOIN1, $Join_type, $select){
        $this->db->select($select);
        $this->db->from($table);
        $this->db->JOIN($table1, $JOIN, $Join_type);
        $this->db->JOIN($table2, $JOIN1, $Join_type);
